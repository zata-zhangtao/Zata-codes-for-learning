...
# 定义处理消息并生成回复的节点
def chatbot_node(state: CustomMessagesState):
    # 获取当前状态中的消息
    ...
    # 返回更新后的状态，包含新的 AI 消息
    return {"user_id": state["user_id"], "session_id": state["session_id"], "messages": [response]}
...
# 使用初始消息运行图
initial_state = {"user_id": "123", "session_id": 1, "messages": [HumanMessage(content="你好！今天能帮我什么？")]}
